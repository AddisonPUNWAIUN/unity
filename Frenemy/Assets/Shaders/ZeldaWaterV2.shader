...
Shader "Custom/ZeldaWater_V2" {
	Properties {
        ...
        _SpeedX ("SpeedX", Range (0.001, 1.0)) = .1
        _SpeedY ("SpeedY", Range (0.001, 1.0)) = .1
		...
		_Emboss ("Emboss", Range (0, 1.0)) = .1
		_HeightScale ("HeightScale", Range (0, 3.0)) = 0
		_NoiseScale ("NoiseScale", Range (0, 2.0)) = 0
		_WaveSpeed ("WaveSpeed", Range (0, 10.0)) = 0
	}
	SubShader {
		Pass {		
			CGPROGRAM
